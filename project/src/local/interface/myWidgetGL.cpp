...
void myWidgetGL::initializeGL()
{
    ...
    scene_3d.change_bille_state(scene_3d.get_bille_state());
    scene_3d.change_cube_state(scene_3d.get_cube_state());
    scene_3d.change_cat_state(scene_3d.get_cat_state());
    scene_3d.load_scene();
...
void myWidgetGL::reset(bool const is_reset)
{
    if(is_reset==true)
    {
...
void myWidgetGL::Bille(bool const is_bille)
{
    scene_3d.change_bille_state(is_bille);
    updateGL();
}

void myWidgetGL::Cube(bool const is_cube)
{
    scene_3d.change_cube_state(is_cube);
    updateGL();
}

void myWidgetGL::Chat(bool const is_chat)
{
    scene_3d.change_cat_state(is_chat);
    updateGL();
}
...
void myWidgetGL::get_value_K1(int val_K1)
{
     scene_3d.changeK1(val_K1);
}

void myWidgetGL::get_value_K2(int val_K2)
{
     scene_3d.changeK2(val_K2);
}

void myWidgetGL::get_value_K3(float val_K3)
{
     scene_3d.changeK3(val_K3);
}

void myWidgetGL::get_value_KWind(float val_KWind)
{
     scene_3d.changeKWind(val_KWind);
}

void myWidgetGL::get_uWind_x_value(int val_x)
{
     scene_3d.change_ux(val_x);
}

void myWidgetGL::get_uWind_y_value(int val_y)
{
     scene_3d.change_uy(val_y);
}

void myWidgetGL::get_rayon_value(int val_rayon)
{
    scene_3d.change_rayon(val_rayon);
}
